...
private val weatherEmojis = mapOf(
  ...
  // Fog
  45 to "🌫️", // Fog
  48 to "🌫️", // Depositing rime fog

  // Drizzle & Rain
  51 to "🌦️", // Drizzle Light
  53 to "🌦️", // Drizzle Moderate
  55 to "🌧️", // Drizzle Dense
  56 to "🧊", // Freezing Drizzle Light
  57 to "🧊", // Freezing Drizzle Dense
  61 to "💧", // Rain Slight
  63 to "🌧️", // Rain Moderate
  65 to "🌊", // Rain Heavy
  ...
  // Snow
  71 to "🌨️", // Snow Slight
  73 to "❄️", // Snow Moderate
  75 to "☃️", // Snow Heavy
  77 to "🍚", // Snow grains (крупа)

  // Showers
  80 to "🌦️", // Rain showers Slight
  81 to "🌧️", // Rain showers Moderate
  82 to "☔", // Rain showers Violent
  85 to "🌨️", // Snow showers Slight
  86 to "❄️", // Snow showers Heavy

  // Thunderstorm
  95 to "⚡", // Thunderstorm
  96 to "⛈️", // Thunderstorm + Hail Slight
  99 to "🌪️"  // Thunderstorm + Hail Heavy
)
...
object AppStrings {
  ...
  suspend fun init(context: Context) {
    ...
    withContext(Dispatchers.IO) {
      if (weatherMap == null) {
        weatherMap = allCodes.associateWith { code ->
